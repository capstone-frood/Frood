...
class MeatFragment : Fragment(), MeatContract.View {
    ...
    override fun onCreateView(
        ...
        viewModel.meatListObservable.observe(viewLifecycleOwner){
            fetchMeatList(it)
        }
    ...
    override fun fetchMeatList(meatList: List<Product>) {
        adapterProduct.submitList(meatList)
    }
